...
export default function Navbar() {
    ...
    return (
        <StyledNavbarContainer>
            ...
            <StyledFlexCenterContainer style={{width: 'auto'}}>
                <a onClick={()=> navigate('#history')}>About</a>
                <a onClick={() => navigate('#bubbletokenomics')}>Tokenomics</a>
                <a onClick={() => navigate('#swap')}>Swap</a>
                <a onClick={() => navigate('/shop')}>Merch</a>
                <a onClick={() => navigate('/game')}>Game</a>
