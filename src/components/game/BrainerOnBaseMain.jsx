...
import SocietyMap from "./SocietyMap";
...
export default function BrainerOnBaseMain() {
  ...
  return (
    <StyledFlexFullCenterContainer 
      ...
      <Navbar/>
        {isConnected && gameNavigation === 'main' ? <MainMenu setGameNavigation={setGameNavigation} setIsGameStarted={setIsGameStarted}/>
      : isConnected && gameNavigation === 'society' ? <></>
      : isConnected && gameNavigation === 'map' ? <SocietyMap/>
      : isConnected && gameNavigation === 'settings' ? <GameSettings/>
