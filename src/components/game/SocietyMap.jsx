...
const SocietyMap = ({
    ...
    return (
        <StyledGameMain>
            ...
            <StyledButton className={'animate__animated animate__fadeInDown animate__delay-2s'} style={{zIndex: 4, padding:'1em', width:'280px'}} size={'1.8em'} onClick={() => {setGameNavigation('society')}} >
              GO BACK
            </StyledButton>
            </StyledBlackContainer>
