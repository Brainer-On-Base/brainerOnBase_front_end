export const BRAINER_HISTORY_ARRAY = [
  ...
  `,
  `Play-to-Burn became our empowerment tool. Every game, every mission, every Head House upgrade brings us closer to our goal. Our economy thrives not only on earning NEURON tokens but on empowering each Brainer to take charge, customize their world, and trade on their own terms. Tokens earned in games, through achievements, or from trading rare NFTs are a testament to each Brainer’s journey.
  `,
...
export const BRAINER_BPC_NFT_MINT_CONTRACT_ADDRESS =
  "0x75ef5b5cb5958Bb46C7809459982263c97Ca437e";
...
export const BRAINER_IPFS_METADATA =
  "http://145.223.96.84:8080/ipfs/QmeExBi3v1ZpsbH15srbMnEfk3Zj6nk3EwmzTJtbF8cRnf/";
